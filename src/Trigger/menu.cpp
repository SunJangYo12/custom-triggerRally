...
void MainApp::levelScreenAction(int action, int index)
{
  ...
  case AM_TOP:
    gui.makeClickable(
      gui.addLabel(400.0f,400.0f, "custom", PTEXT_HZA_CENTER | PTEXT_VTA_CENTER, 40.0f), AA_START_CUST, 0);
    ...
    gui.makeClickable(
      gui.addLabel(400.0f,250.0f, "semua level", PTEXT_HZA_CENTER | PTEXT_VTA_CENTER, 40.0f), AA_GO_LVL, 0);
    gui.makeClickable(
      gui.addLabel(10.0f,30.0f, "keluar", PTEXT_HZA_LEFT | PTEXT_VTA_CENTER, 40.0f), AA_GO_QUIT, 0);
